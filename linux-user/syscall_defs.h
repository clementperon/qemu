...
#if (defined(TARGET_I386) && defined(TARGET_ABI32)) || (defined(TARGET_ARM) && defined(TARGET_ABI32)) || defined(TARGET_SPARC) || defined(TARGET_M68K) || defined(TARGET_SH4) || defined(TARGET_CRIS)
...
#if defined(TARGET_I386) || defined(TARGET_ARM) || defined(TARGET_SH4) || defined(TARGET_M68K) || defined(TARGET_CRIS) || defined(TARGET_S390X) || defined(TARGET_OPENRISC) || defined(TARGET_TILEGX) || defined(TARGET_NIOS2) || defined(TARGET_RISCV) || defined(TARGET_XTENSA)
...
#define TARGET_CMSG_ALIGN(len) (((len) + sizeof(abi_long) - 1) & (size_t) ~(sizeof(abi_long) - 1))
                     ...
                     struct target_cmsghdr *__cmsg_start)
{
    ...
    __ptr = (struct target_cmsghdr *)((unsigned char *)__cmsg + TARGET_CMSG_ALIGN(tswapal(__cmsg->cmsg_len)));
    if ((unsigned long)((char *)(__ptr + 1) - (char *)__cmsg_start) > tswapal(__mhdr->msg_controllen))
    {
        /* No more entries.  */
...
#if (defined(TARGET_I386) && defined(TARGET_ABI32)) || (defined(TARGET_ARM) && defined(TARGET_ABI32)) || defined(TARGET_CRIS)
struct target_stat
{
...
struct target_flock64
{
    short l_type;
    short l_whence;
#if defined(TARGET_PPC) || defined(TARGET_X86_64) || defined(TARGET_MIPS) || defined(TARGET_SPARC) || defined(TARGET_HPPA) || defined(TARGET_MICROBLAZE) || defined(TARGET_TILEGX) || defined(TARGET_XTENSA)
    int __pad;
#endif
    abi_llong l_start;
    abi_llong l_len;
...
#else
#define TARGET_SIGEV_PREAMBLE_SIZE (sizeof(int32_t) * 2 + sizeof(target_sigval_t))
#endif

#define TARGET_SIGEV_PAD_SIZE ((TARGET_SIGEV_MAX_SIZE - TARGET_SIGEV_PREAMBLE_SIZE) / sizeof(int32_t))
